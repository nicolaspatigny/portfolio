  ...
  const projects: Project[] = [
    {
      ...
      description:
        "A responsive, animated portfolio website built with React, TailwindCSS and Framer Motion. Features smooth scrolling, interactive elements, and a mobile-first responsive design approach.",
      image:
        "https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=500",
      tags: ["React", "TailwindCSS", "Framer Motion", "TypeScript"],
      year: "2024",
      demoLink: "https://nicolaspatigny-portfolio.netlify.app",
    ...
    },
    {
      ...
      description:
        "A full-stack Battleship game using JavaScript with dynamic DOM manipulation for real-time game board rendering and user interaction.",
      image:
        "https://images.unsplash.com/photo-1604689598793-b8bf1dc445a1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=500",
    ...
    },
    {
      ...
      description:
        "A dynamic restaurant website using vanilla JavaScript and Webpack, with single-page application architecture and tab-based navigation.",
      image:
        "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=500",
      tags: ["JavaScript", "Webpack", "HTML5", "CSS3"],
      year: "2022",
      demoLink: "https://nicolaspatigny.github.io/RestaurantPage/",
    ...
    },
    {
      title: "Meet a Friend",
      description:
        "A real-time chat application in Kotlin for Android, implementing user authentication and message handling systems for anonymous conversations.",
      image:
        "https://images.unsplash.com/photo-1556438064-2d7646166914?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=500",
      tags: ["Kotlin", "Android", "Firebase", "UI/UX"],
      year: "2023",
      demoLink: "https://github.com/nicolaspatigny/NewBSN",
      githubLink: "https://github.com/nicolaspatigny/NewBSN",
      tagColors,
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-center max-w-3xl text-gray-600">
            ...
            develop different skills and tackle unique challenges.
          </p>
        </motion.div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className={`px-3 py-1 ${
                        tagColors[tag]?.bg || "bg-gray-100"
                      } ${
                        tagColors[tag]?.text || "text-gray-800"
