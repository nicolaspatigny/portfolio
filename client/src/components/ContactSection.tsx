          ...
          >
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:nick.patigny@gmail.com" className="text-primary hover:underline">nick.patigny@gmail.com</a>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="tel:+33763940008" className="text-primary hover:underline">+33 7 63 94 00 08</a>
              </div>
            </div>
